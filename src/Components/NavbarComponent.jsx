...
import Nav from 'react-bootstrap/Nav'; // you forgot this!
            ...
            <Navbar expand="lg" style={{ backgroundColor: '#EFF9F9' }} className="px-4">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <div className="d-flex">
                        <Button href="#contact" variant="success" className="d-none d-md-flex ms-2 fw-bold px-4" style={{ boxShadow: 'none' }}>
                            CONTACT US
                        </Button>
                    </div>
                </Navbar.Collapse>
